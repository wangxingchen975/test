$(function () {
    ...
    function echart_1() {
        ...
        var title = "2018,2019就业人数";//标题
        var serieData = [];
        var metaDate = [
            data,
            [1500, 1200, 1800, 2500, 1700, 1500, 2000, 1800, 2800, 1900, 2500, 2000, 2500, 1700, 2600, 2700, 2900, 3000, 3200, 3100]
        ]
    ...
    function echart_2() {
        ...
        myChart.setOption({
            ...
            yAxis: {
                type: 'category',
                data: ['大数据分析师','Java工程师','PHP','C语言','web前端工程师'],
                axisTick: {
                    show: false
                },
                splitLine: {
    ...
    function echart_3() {
        ...
        option = {
            ...
            series: [{
                ...
                symbolSize: 9,
                  symbol: 'circle',
                data: [60, 90, 39, 70, 90, 82, 120, 89, 92, 80, 60, 100]
            }, {
                name: '',
                smooth: true,
                type: 'line',
                symbolSize: 9,
                  symbol: 'circle',
                data: [80, 50, 100, 87, 90, 80, 100, 77, 86, 60, 96, 99]
            }, {
                name: '',
                smooth: true,
                type: 'line',
                symbolSize: 9,
                  symbol: 'circle',
                data: [90, 112, 80, 100, 60, 70, 60, 131, 80, 102, 95, 105 ]
            }, 
            {
                type: 'pie',
                center: ['83%', '33%'],
